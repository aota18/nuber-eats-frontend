...
export const Dish:React.FC<IDishProps> = ({
    ...
    return ( 
        <div 
            ...
            className={`px-8 pt-3 pb-8 border cursor-pointer transition-all ${isSelected ? "border-gray-800" : "hover:border-gray-800"}` }>
            <div className="mb-5">
                ...
                <h3 className="text-lg font-medium flex items-center ">
                    {name}
                    {
                        orderStarted && 
                            <button className={
                                `ml-3 py-1 px-3 focus:outline-none text-sm text-white ${
